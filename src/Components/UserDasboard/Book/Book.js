...
const Book = ({handlePayment}) => {
    ...
    const [isUserData, setIsUserData] = useState({isData: false});
        ...
        <div className='row'>
            ...
            <div className="col-md-10 mt-5 ml-5" style={{position: 'absolute', right: 0}}>
                <div className="ms-4">
                        ...
                        {
                            serviceInfo.map(service => <input onSubmit={handleChange} name='service' className='w-50' type="text" placeholder='Enter your service' value={service.name}/>)
                        } <br/>
